...
#4
  ...
  new_Quercus_ajoensis <- subset(Quercus_ajoensis,!(UID %in% c("id00036637", "id00034626", "id00076618",
                                                              ...
                                                              "id00076600", "id00076589", "id00076688", 
                                                              "id00076688", "id00076589", "id00076694"))& !(datasetName %in% "iNaturalist research-grade observations"))
...
#10
  ...
  new_Quercus_cedrosensis = subset(Quercus_cedrosensis,!(UID %in% c("id00035830", "id00025050", "id00000337",
                                                                    ...
                                                                    "id00004260", "id00381179", "id00380746",
                                                                    "id00380743", "id00380741"))& !(datasetName %in% "iNaturalist research-grade observations"))
...
#21
  ...
  new_Quercus_dumosa3 = subset(new_Quercus_dumosa2,!(UID %in% c("id00039667", "id00031856", "id00056936",
                                                                ...
                                                                "id00056954", "id00040624", "id00381215",
                                                                "id00381219", "id00381226", "id00381227",
                                                                "id00381230", "id00381250", "id00381266",
                                                                "id00381267", "id00381275", "id00381287",
                                                                "id00381290", "id00381329", "id00381330",
                                                                "id00381337", "id00381349", "id00381355",
                                                                "id00381374", "id00381380", "id00381392",
                                                                "id00381399", "id00381400", "id00381401",
...
#23
  ...
  new_Quercus_engelmannii = subset(Quercus_engelmannii,!(UID %in% c("id00038895", "id00000660", "id00000678",
                                                                    ...
                                                                    "id00238890", "id00238886", "id00036575"))& !(datasetName %in% "iNaturalist research-grade observations"))
...
#25
  ...
  new_Quercus_furfuracea = subset(Quercus_furfuracea, !(UID %in% c("id00244248", "id00244247", "id00244246",
                                                                   "id00000700", "id00036395", "id00224999",
                                                                   "id00224998", "id00225000"))& !(datasetName %in% "iNaturalist research-grade observations"))
...
#33
  ...
  new_Quercus_hintonii = subset(Quercus_hintonii,!(UID %in% c("id00044047", "id00044046", "id00036129",
                                                              ...
                                                              "id00032183"))& !(datasetName %in% "iNaturalist research-grade observations"))
...
#34
  ...
  new_Quercus_hintoniorum = subset(Quercus_hintoniorum,!(UID %in% c("id00000757", "id00036813", " id00012485",
                                                                   "id00012485", "id00275737", "id00043314"))& !(datasetName %in% "iNaturalist research-grade observations"))
...
#59
  ...
  new_Quercus_toumeyi = subset(Quercus_toumeyi,!(UID %in% c("id00072873", "id00072995", "id00073032",
                                                            ...
                                                            "id00032276", "id00073167", "id00072814", 
                                                            "id00073200", "id00038728"))& !(datasetName %in% "iNaturalist research-grade observations"))
